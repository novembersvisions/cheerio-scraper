...
function fullText($,url,include) {
    ...
    var linkSearches = (include !== '') ? [include+' a',include] : ['a'];
...
// TODO: modify script so it can accept child element selectors as well as an array of include selectors
